...
Begin {
    ...
    Function Get-ActiveUserHashTable {
        ...
        Try {
            ...
            $FilteredResults = ($ReportResults | Where-Object {($_.$ELAD -ne '') -and ($_.$ELAD -ne $null) -and ([datetime]($_.$ELAD) -ge (Get-Date).AddMonths(-12))})
    ...
    If (($ReportResults -eq $false) -or ($ReportResults -eq $null)) {
        ...
        If ($O365ActiveUserHash -is [hashtable]) {
            ...
            $adParams = @{
                ...
                SearchScope = 'Subtree'
                Properties  = 'SamAccountName', 'UserPrincipalName', 'LastLogonDate', 'employeeID', 'Enabled', 'Description'
            }
